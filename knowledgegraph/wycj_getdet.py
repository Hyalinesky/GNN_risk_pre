...
def spider():
    ...
    # csv2xls("网易财经.csv","wycj_getdet_cache.xls")
    #从excel获取查询单位
    worksheet = xlrd.open_workbook(u'wycj_getdet_cache.xls')
    ...
    for i in range(inc_len):
        ...
        df2.save('wycj_getdet_cache.xls')
        # txt='江苏孜航精密五金有限公司'
        time.sleep(1)
        ...
        try:
            # 获取网页地址，进入
            inner = driver.find_element(by=By.XPATH,value='/html[1]/body[1]/div[1]/div[2]/div[2]/div[4]/div[1]/div[2]/div[1]/table[1]/tr[1]/td[3]/div[1]/span[1]/span[1]/a[1]').get_attribute('href')
            driver.get(inner)
            time.sleep(2)
            # 弹出框按钮
            try:
                try:
                    # 名称
                    NAME = driver.find_element(by=By.XPATH,value='/html[1]/body[1]/div[1]/div[2]/div[5]/div[2]/div[1]/div[2]/section[2]/div[2]/table[1]/tr[1]/td[4]/span[1]/span[1]').text
                    # 成立年数
                    CLNS = driver.find_element(by=By.XPATH,value='/html[1]/body[1]/div[1]/div[2]/div[5]/div[2]/div[1]/div[2]/section[2]/div[2]/table[1]/tr[2]/td[6]/span[1]/span[1]').text
                    CLNS = str(2022-int(CLNS[0:4]))
                    # 注册资本
                    ZCZB = driver.find_element(by=By.XPATH,
                                               value='/html[1]/body[1]/div[1]/div[2]/div[5]/div[2]/div[1]/div[2]/section[2]/div[2]/table[1]/tr[3]/td[2]').text
                    ZCZB = ZCZB.rstrip('万元人民币')
                    # 实缴资本
                    SJZB = driver.find_element(by=By.XPATH,
                                               value='/html[1]/body[1]/div[1]/div[2]/div[5]/div[2]/div[1]/div[2]/section[2]/div[2]/table[1]/tr[3]/td[4]').text
                    SJZB = SJZB.rstrip('万元人民币')
                    #股东人数
                    try:
                        GDRS = driver.find_element(by=By.XPATH,
                                               value='/html[1]/body[1]/div[1]/div[2]/div[5]/div[2]/div[1]/div[2]/section[3]/div[2]/div[1]/span[1]/span[1]/a[1]/span[2]').text
                    except:
                        GDRS = '1'
                    #企业标签
                    try:
                    ...
                    try:
                        FZJGS = driver.find_element(by=By.XPATH,
                                                    value='/html[1]/body[1]/div[1]/div[2]/div[5]/div[2]/div[1]/div[1]/a[7]').text
                    ...
                    try:
                        KZQYS = driver.find_element(by=By.XPATH,
                                                    value='/html[1]/body[1]/div[1]/div[2]/div[5]/div[2]/div[1]/div[1]/a[12]').text
                    ...
                    try:
                        JJCGQYS = driver.find_element(by=By.XPATH,
                                                    value='/html[1]/body[1]/div[1]/div[2]/div[5]/div[2]/div[1]/div[1]/a[13]').text
                    ...
                    try:
                        QQGLQYS = driver.find_element(by=By.XPATH,
                                                    value='/html[1]/body[1]/div[1]/div[2]/div[5]/div[2]/div[1]/div[1]/a[17]').text
                    ...
                    try:
                        XTGDS = driver.find_element(by=By.XPATH,
                                                    value='/html[1]/body[1]/div[1]/div[2]/div[5]/div[2]/div[1]/div[1]/a[18]').text
                    ...
                    try:
                        srh_btn = driver.find_element(by=By.XPATH,
                                                      value='/html[1]/body[1]/div[1]/div[2]/div[4]/div[1]/div[1]/div[1]/a[4]/h2[1]/div[1]')
                        srh_btn.click()
                        time.sleep(1)
                        try:
                            JYYC = driver.find_element(by=By.XPATH,
                                                        value='/html[1]/body[1]/div[1]/div[2]/div[5]/div[4]/div[1]/div[1]/a[5]').text
                            if JYYC != '经营异常 0':
                                JYYC = '1'
                            else:
                                JYYC = '0'
                    ...
                    print(NAME, CLNS, ZCZB, GDRS, XTGDS, Slabel, XSlabel, KZQYS, JJCGQYS, QQGLQYS, JYYC)
...
def save_csv(info_list):
    #4.存储数据
    #存储路径
    f = open('网易财经扩展data.csv',mode='a',newline='',encoding='utf-8')
